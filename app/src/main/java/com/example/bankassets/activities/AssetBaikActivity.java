...
public class AssetBaikActivity extends BaseActivity {
    ...
    private TextView jumlahAssetBaik;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jumlahAssetBaik.setText(String.valueOf(assetList.size()));
    ...
    private void showAllAsset() {
        ...
        jumlahAssetBaik.setText(String.valueOf(filteredList.size()));
    }
